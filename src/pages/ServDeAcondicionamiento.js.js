...
const ServDeAcondicionamiento = props => {
    ...
    return (
        ...
        <div>
            <ServicesHeading classToAdd="acondicionamiento" subtitle={"La calidad es nuestra primera prioridad."} title={"A partir del 1 de Julio de 2022 estas seran las tarifas de las plantas de acondicionamiento de San Lorenzo, Gral Lagos, Pto Gral San Martin y Timbues."} />
            <DividerIcon />
            <Container className="mt-5">
               <Row>
                   ...
                   <Col md={6} sm={12} className="text-right">
                    <h3 className="white gold-bg bold px-5 ml-auto py-1" style={{width:"max-content"}}>Septiembre 2022</h3>
                   </Col>
               </Row>
               <Row>
                   <Col md={3} className="d-flex mt-5 flex-column text-center aling-items-center">
                        ...
                        <div className="text-center gold flex-column d-flex" style={{backgroundImage:`url(${octogonoLarge})`,backgroundSize:"contain",minHeight:"180px",backgroundRepeat:"no-repeat",backgroundPosition:"center"}}>
                            <h2 style={{fontSize:"48px"}} className="bold mb-0 mt-auto large">$85.00</h2>
